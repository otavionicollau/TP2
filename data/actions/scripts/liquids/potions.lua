...
local POTIONS = {
	...
	[8473] = {empty = 7635, splash = 2, health = {1730, 1885}, level = 1, vocations = {4, 8}, vocStr = "knights"}, -- ultimate health potion
	...
	[7590] = {empty = 7635, splash = 7, mana = {1000, 1250}, level = 1, vocations = {1, 2, 5, 6}, vocStr = "sorcerers and druids"}, -- great mana potion

	[8472] = {empty = 7635, splash = 3, health = {1050, 1150}, mana = {450, 550}, level = 1, vocations = {3, 7}, vocStr = "paladins"} -- great spirit potion
}
