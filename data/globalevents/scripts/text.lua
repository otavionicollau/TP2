local effects = {
    {position = Position(157, 44, 7), text = 'Bonus Diario!', effect = 32},
    ...
    {position = Position(158, 45, 7), text = '', effect = 62},
    ...
    {position = Position(159, 45, 7), text = 'AREA EXCLUSIVA P/ DONATE!!', effect = 62},
    {position = Position(167, 47, 7), text = 'AREA II', effect = 43},
    {position = Position(171, 47, 7), text = 'AREA III', effect = 45},
    {position = Position(163, 47, 7), text = 'AREA I', effect = 44},
    {position = Position(175, 47, 7), text = 'AREA IV', effect = 49},
