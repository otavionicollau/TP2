local effects = {
    {position = Position(159, 49, 7), text = 'BONUS', effect = CONST_ME_GROUNDSHAKER},
    {position = Position(281, 254, 8), text = 'TP Room'}, -- text only
    {position = Position(153, 46, 7), text = 'Monters', effect = CONST_ME_GROUNDSHAKER},
    {position = Position(151, 46, 7), text = 'Quests', effect = CONST_ME_GROUNDSHAKER},
    {position = Position(160, 45, 7), text = 'Area', effect = CONST_ME_GROUNDSHAKER},
    {position = Position(161, 45, 7), text = 'Donate', effect = CONST_ME_GROUNDSHAKER},
