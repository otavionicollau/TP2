local effects = {
    ...
    {position = Position(153, 46, 7), text = 'Monters', effect = 72},
    ...
    {position = Position(161, 45, 7), text = 'Area somente Donate!!', effect = 62},
    ...
    {position = Position(146, 49, 7), text = 'Treiner Offine', effect = 57},
    {position = Position(146, 49, 7), text = '', effect = 48},
    {position = Position(163, 51, 7), text = 'NPCS', effect = 49},
    {position = Position(149, 46, 7), text = 'Area de Treinamento', effect = 50},
}
