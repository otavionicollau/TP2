...
keywordHandler:addKeyword({'help'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "Voce Deseja Compra Skills Se Quiser Compra Magic Digite Magic. E etc?"})
